...
void Main()
{
	var battles = new(string Setup, string Outcome)[] {
		(@"#######
#G..#E#
#E#E.E#
#G.##.#
...
#######") //27730
	...
	foreach (var battle in battles.Skip(5))
	{
		Console.WriteLine();
		Console.WriteLine("FIGHT");
		var battlefield = new Battlefield(battle.Setup);
		...
		while (battlefield.BattleRages())
		{
			...
			foreach (var combatant in combatantsInReadingOrder)
			{
				if (!combatant.Dead)
				{
					...
					//DebugConsole.WriteLine(battlefield.ToString());
				}
			}
			DebugConsole.WriteLine(battlefield.ToString());
		}
		...
		Console.WriteLine(battlefield.BodyCount);
	}
}
public class Battlefield
{
	...
	public Battlefield(string field)
	{
