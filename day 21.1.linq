...
void Main()
{
	var register1 = 16134795;
	var fewestExecutionsSoFar = int.MaxValue;
	var bestRegisterValueSoFar = int.MaxValue;
	while (register1 >= 0)
	{
		...
		for (; ; )
		{
			...
			executions++;
			if (executions > fewestExecutionsSoFar || executions == int.MaxValue) break;
