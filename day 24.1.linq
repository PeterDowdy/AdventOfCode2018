...
{
		var combatants = new[] {
	new Combatant { Name = GetName().First(), Count = 3115, HitPoints =1585,Weaknesses = new[] { "slashing", "bludgeoning" }, Attack =4, AttackType = "slashing", Initiative =7, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 3866, HitPoints = 6411,Weaknesses = new[] { "cold", "radiation"}, Immunities = new[] { "fire" }, Attack = 14, AttackType = "slashing", Initiative = 11, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 40, HitPoints = 10471, Weaknesses = new[] { "bludgeoning", "slashing"}, Immunities = new[] { "cold" }, Attack = 2223, AttackType = "cold", Initiative = 3, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 1923, HitPoints = 2231, Weaknesses = new[] { "slashing", "fire" }, Attack = 10, AttackType = "bludgeoning", Initiative = 13, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 4033, HitPoints = 10164, Immunities = new[] { "slashing" }, Attack = 22, AttackType = "radiation", Initiative = 5, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 36, HitPoints = 5938, Weaknesses = new[] { "bludgeoning", "cold"}, Immunities = new[] { "fire" }, Attack = 1589, AttackType = "slashing", Initiative = 4, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 2814, HitPoints = 7671, Weaknesses = new[] { "cold" }, Attack = 21, AttackType = "radiation", Initiative = 15, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 217, HitPoints = 9312, Immunities = new[] { "slashing" }, Attack = 345, AttackType = "radiation", Initiative = 8, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 38, HitPoints = 7686, Weaknesses = new[] { "bludgeoning" }, Attack = 1464, AttackType = "radiation", Initiative = 14, Type = "defender" },
	new Combatant { Name = GetName().First(), Count = 5552, HitPoints = 3756, Weaknesses = new[] { "slashing" }, Attack = 6, AttackType = "fire", Initiative = 10, Type = "defender" },
	...
	new Combatant { Name = GetName().First(), Count = 4288, HitPoints = 20026,Attack = 7, AttackType = "radiation", Initiative = 2, Type = "attacker" },
		...
		while (combatants.Any(d => d.Type == "defender" && d.Count > 0) && combatants.Any(a => a.Type == "attacker" && a.Count > 0))
		{
			...
			foreach (var key in targets.Keys.OrderByDescending(k => k.Initiative))
			{
				...
				if (damage / targets[key].HitPoints > 0) targets[key].Count -= damage / targets[key].HitPoints;
			}
		}
